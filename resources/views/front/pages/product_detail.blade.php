...
@section('content')
                ...
                <div class="cont-desc span_1_of_2">
                    <div class="product-details">
                                ...
                                <div id="products_example">
                                    <div id="products">
                                        <div class="slides_container">
                                            <a href="#" target="_blank"><img src="upload/images/products/{{ $product->pro_image }}" alt=" " /></a>
                        ...
                        <div class="desc span_3_of_2">
                            ...
                            <div class="price">
                                <p>Price: <span>{{ $product->pro_price }}</span></p>
                            </div>
                            <div class="available">
                            ...
                            <div class="share-desc">
                                <div class="share">
                                    <p>Share Product :</p>
                                    <ul>
                                        <li><a href="#"><img src="assets/front/images/facebook.png" alt="" /></a></li>
                                        <li><a href="#"><img src="assets/front/images/twitter.png" alt="" /></a></li>
                                    </ul>
                                </div>
    ...
    @section('css')
        ...
        <link href="assets/front/css/easy-responsive-tabs.css" rel="stylesheet" type="text/css" media="all"/>
    @endsection

    @section('script')
        <script src="assets/front/js/slides.min.jquery.js"></script>
